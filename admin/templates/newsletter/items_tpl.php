...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=newsletter&act=man<?php if($type!='') echo'&type='. $type;?>"><span>Quản lý <?=$title_main?></span></a></li>
        	<?php if($_GET['keyword']!=''){ ?>
...
<table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
	...
	<tr style="text-align:center">
        ...
        <td  style="width:10%;" align="center"><b><?=$items[$i]['hoten']?></b></td>
        <td  style="width:10%;" align="center"><b><?=$items[$i]['sdt']?></b></td>
        <td  style="width:10%;" align="center"><b><?=$items[$i]['diachi']?></b></td>
        <td  style="width:10%;" align="center"><b><?=$items[$i]['email']?></b></td>
        <td  style="width:30%;" align="center"><b><?=$items[$i]['noidung']?></b></td>
		
		<td style="width:10%;"><a href="index.php?com=newsletter&act=delete&type=<?=$_GET['type']?>&id=<?=$items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="./images/icons/dark/close.png" alt=""></a></td>
