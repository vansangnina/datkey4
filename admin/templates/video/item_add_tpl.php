...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=video&act=man&type=<?=$type?>"><span>Video</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=video&act=save<?php if($_REQUEST['curPage']!='') echo'&curPage='.$_REQUEST['curPage'];?>&type=<?=$type?>" method="post" enctype="multipart/form-data">
