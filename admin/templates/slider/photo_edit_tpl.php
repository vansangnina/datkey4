...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=slider&act=man_photo<?php if($type!='') echo'&type='. $type;?>"><span>Hình ảnh</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=slider&act=save_photo&id=<?=$_REQUEST['id'];?><?php if($_REQUEST['id_slider']!='') echo'&id_slider='. $_REQUEST['id_slider'];?><?php if($type!='') echo'&type='. $type;?><?php if($p!='') echo'&p='.$p;?>" method="post" enctype="multipart/form-data">
	<div class="widget">
       ...
       <?php if($type=='slidersp') { ?>
		...
		<div class="formRow">
			...
			<div class="formRight">
               ...
               <div class="note">  
			   <?php if($type=='slider')echo 'Width:1366px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:545px '; ?>
                 
                <?php if($type=='slider3')echo 'Width:600px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:160px '; ?>
                
                <?php if($type=='slide_index')echo 'Width:1366px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:260px '; ?> 
                
                <?php if($type=='hiephoi' || $type=='doitac')echo 'Width:195px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:140px '; ?>  
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?=_format_duoihinh_l?> 
    			</div>
			</div>
			<div class="clear"></div>
