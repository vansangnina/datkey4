...
<form name="supplier" id="validate" class="form" action="index.php?com=slider&act=save_photo&id_slider=<?=$_REQUEST['id_slider']?>&type=<?=$type?><?php if($p!='') echo'&p='.$p;?>" method="post" enctype="multipart/form-data">
