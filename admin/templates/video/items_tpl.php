...
<script language="javascript" type="text/javascript">
	...
	$("#xoahet").click(function(){
		...
		if (hoi==true) document.location = "index.php?com=video&act=delete&type=<?=$type?>&listid=" + listid;
	});
	});
	...
	{	
		...
		window.location ="index.php?com=video&act=man&type=<?=$type?>&key="+a;	
		return true;
	}	
</script>
...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=video&act=man&type=<?=$type?>"><span>Danh sách video</span></a></li>
        	<?php if($_GET['key']!=''){ ?>
...
<div class="control_frm" style="margin-top:0;">
  	<div style="float:left;">
    	<input type="button" class="blueB" value="Thêm" onclick="location.href='index.php?com=video&act=add&type=<?=$type?>'" />
...
<div class="widget">
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    ...
    <tbody>
    <form name="f" id="f" method="post" action="index.php?com=video&act=man&type=<?=$type?>">
       ...
       <td>
        ...
        <td class="title_name_data">
            <a href="index.php?com=video&act=edit&id=<?=$items[$i]['id']?><?php if($p!='') echo'&p='.$p;?>&type=<?=$type?>" class="tipS SC_bold">
                  <?=$items[$i]['ten']?>
            </a>
        </td>
        ...
        <td class="actBtns">
            <a href="index.php?com=video&act=edit&id=<?=$items[$i]['id']?><?php if($p!='') echo'&p='.$p;?>&type=<?=$type?>" title="" class="smallButton tipS" original-title="Sửa Video"><img src="./images/icons/dark/pencil.png" alt=""></a>
           
            <a href="index.php?com=video&act=delete&id=<?=$items[$i]['id']?><?php if($p!='') echo'&p='.$p;?>&type=<?=$type?>" onClick="if(!confirm('Xác nhận xóa <?=$items[$i]['ten']?>')) return false;" title="" class="smallButton tipS" original-title="Xóa bài viết"><img src="./images/icons/dark/close.png" alt=""></a>      
             </td>
      </tr>
         <?php } ?>
         </form> 
